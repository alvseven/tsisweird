        ...
        <motion.div variants={item} className="w-full lg:w-4/5">
          ...
          >
            <div className="relative" ref={shareMenuRef}>
              ...
              {shareMenuOpen && (
                <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-[#1a1f3d] border border-indigo-900 rounded-lg shadow-xl overflow-hidden min-w-[200px] z-50">
                  <button
                    onClick={copyToClipboard}
                    className="flex items-center justify-center gap-3 w-full px-4 py-3 text-sm text-slate-200 hover:bg-indigo-900/40 transition-colors font-roboto-mono"
                  >
                    {copied ? <Check className="w-4 h-4 shrink-0 text-green-400" /> : <Copy className="w-4 h-4 shrink-0" />}
