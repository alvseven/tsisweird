...
export function Header({ isPlaying }: HeaderProps) {
    return <header className="fixed top-0 left-0 right-0 z-50 w-full h-14 flex items-center justify-center p-4 bg-gradient-to-r from-[#04162f] via-[#10132B] to-[#071c3b] ">
