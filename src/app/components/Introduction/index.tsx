...
export function Introduction() {
    return <div className="flex flex-col items-center justify-center gap-12 w-full animate-pulse relative">
        <h1 className="text-[1.6rem] sm:text-3xl font-inknut-antiqua text-center relative tracking-wider">Typescript is weird</h1>
